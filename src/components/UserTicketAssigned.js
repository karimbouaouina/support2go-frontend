...
function UserTicketAssigned() {
    ...
    const handleUpdateClick = () => {
      navigate(`/user-dashboard/${id}/update`);
  };
    ...
    const handleCloseTicket = async () => {
        ...
        try {
          const response = await axios.put(`/api/tickets/${id}/close`, {}, config);
          setTicket(response.data); 
        } catch (error) {
...
export default UserTicketAssigned;
